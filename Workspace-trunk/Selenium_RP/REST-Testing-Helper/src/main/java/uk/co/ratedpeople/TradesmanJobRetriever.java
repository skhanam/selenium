...
public class TradesmanJobRetriever {

	private static final Logger LOGGER = Logger.getLogger(TradesmanJobRetriever.class.getName());
	...
	private String getJobUri(int userid, String jobRef){
		return "/api/v1/tradesmen/" + userid + "/jobs/" + jobRef;
	}
	
	private String getAvailableJobListURI(int userid, int startIndex, int numberOfItems) {
		return "/api/v1/tradesmen/" + userid + "/jobs/available?start_index=" + startIndex + "&numberOfItems=" + numberOfItems;
	}
	
	private String getPurchasedJobListURI(int userid, int startIndex, int numberOfItems) {
		return "/api/v1/tradesmen/" + userid + "/jobs/purchased?start_index=" + startIndex + "&numberOfItems=" + numberOfItems;
	}
