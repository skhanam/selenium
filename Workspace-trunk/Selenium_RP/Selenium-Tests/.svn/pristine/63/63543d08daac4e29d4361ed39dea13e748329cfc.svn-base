...
public class SignUpVariant_C_DynamicTextCheckTest extends TestScript {
	...
	private SignUpVariant_C_DynamicTextCheck signUpVariant_C_DynamicTextCheck;
	private UniqueEmailAddressGenerator uniqueEmailAddressGenerator;

	@BeforeClass
	public void beforeClass() throws Exception {
		signUpVariant_C_DynamicTextCheck = new SignUpVariant_C_DynamicTextCheck(this.context, scriptUtilities);
	...
	public void testSignUpVarC_15_30(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
		...
		signUpVariant_C_DynamicTextCheck.signUpVarC(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
	}

	@Test(dataProvider = "data_15_50", enabled = true)
	public void testSignUpVarC_15_50(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
			final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_C_DynamicTextCheck.signUpVarC(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
	...
	public void testSignUpVarC_0_50(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
			final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_C_DynamicTextCheck.signUpVarC(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
