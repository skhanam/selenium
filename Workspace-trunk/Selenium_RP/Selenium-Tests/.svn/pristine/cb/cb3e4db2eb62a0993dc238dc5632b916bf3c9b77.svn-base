...
public class SignUpVariant_E_DynamicTextCheckTest extends TestScript {
	...
	private SignUpVariant_E_DynamicTextCheck signUpVariant_E_DynamicTextCheck;
	private UniqueEmailAddressGenerator uniqueEmailAddressGenerator; 
	
	@BeforeClass
	public void beforeClass() throws Exception {
		signUpVariant_E_DynamicTextCheck = new SignUpVariant_E_DynamicTextCheck(this.context, scriptUtilities);
	...
	public static Object[][] postCode() {
		return new Object[][] {
				...
				{ MONTHLY, _0_50_418486A9E548, "PASSPORTGBR", "1 month free trial", "50", "15", "120" },
				{ ANNUAL, _0_50_418486A9E548, "PASSPORTGBR", "1 month free trial", "50", "15", "120" },
			};
	}

	
	@Test(dataProvider = "data_15_30", enabled = true)
	public void testSignUpVarE_15_30(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount, final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_E_DynamicTextCheck.signUpVarE(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount, monthlyRollOnAmount, annualRollOnAmount);
	}
	
	@Test(dataProvider = "data_15_50", enabled = true)
	public void testSignUpVarE_15_50(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount, final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_E_DynamicTextCheck.signUpVarE(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount, monthlyRollOnAmount, annualRollOnAmount);
	}

	@Test(dataProvider = "data_0_50", enabled = true)
	public void testSignUpVarE_0_50(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount, final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_E_DynamicTextCheck.signUpVarE(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount, monthlyRollOnAmount, annualRollOnAmount);
	}
