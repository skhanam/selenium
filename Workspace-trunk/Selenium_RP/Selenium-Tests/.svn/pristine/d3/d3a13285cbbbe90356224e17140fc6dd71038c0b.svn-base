...
public class SignUpVariant_C_AndLogInTest extends TestScript {


	private SignUpVariant_C_AndLogin signUpVariant_C_AndLogin;
	...
	public void beforeClass() throws Exception {
		...
		signUpVariant_C_AndLogin = new SignUpVariant_C_AndLogin(this.context, scriptUtilities);
		signUpVariantC = new SignUpVariantC(this.context, scriptUtilities);
	}
	...
	public void signupVarCTest(final String rollOnType, final String tariff, final String screeningType, String tarriffText, String credit) throws Exception {
		...
		signUpVariantC.signUpVarC(uniqueEmailAccountName, rollOnType, tariff, screeningType);
		signUpVariant_C_AndLogin.login(uniqueEmailAccountName, "password");
		signUpVariant_C_AndLogin.checkPostcode(SignupVarCXpathlocators.dataLookup.get("postcode"));
		signUpVariant_C_AndLogin.checkBilling(tarriffText, credit);
		List<String> skillList = createListSkills();

		signUpVariant_C_AndLogin.checkTrade(skillList);
