...
public class PostJobViaPortableJobFormTestConcertinaTwoPanelShowPanel extends TestScript{
	...
	public void testWebdriverjunit() throws Exception {
		driver.get(baseUrl + "/test-cases/test-case.php?jts=consertina&jdl=2&hwp=true&prese=false");
		...
		driver.findElement(By.xpath("//html/body/div/div/div/div[2]/form/div[2]/div/fieldset/div[2]/select/option[4]")).click();
