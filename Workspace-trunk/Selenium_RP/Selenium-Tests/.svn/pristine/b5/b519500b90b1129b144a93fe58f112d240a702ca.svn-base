...
public class SignUpVariantDTest extends TestScript {

	private SignUpVariantD signupDrivingLicense;

	@BeforeClass
	public void beforeClass() throws Exception {

		signupDrivingLicense = new SignUpVariantD(this.context, scriptUtilities);
	}
	...
	public void signupVarDTest(final String rollOnType, final String tariff, final String screeningType) throws Exception {
		String uniqueEmailAccountName = new UniqueEmailAddressGenerator().generateUniqueEmailAddress();
		signupDrivingLicense.signUpVarD(uniqueEmailAccountName, rollOnType, tariff, screeningType);
