...
public class SignUpVariant_E_AndCheckTariffAndSkill {
	...
	public SignUpVariant_E_AndCheckTariffAndSkill(SeleniumTestContext context, TestScriptUtilities scriptUtilities) {
	...
	public void checkPostcode(String postcode) throws Exception {
		...
		assertEquals(driver.findElement(By.id("postcode")).getText().replace(" ", ""), postcode.toUpperCase());
		scriptUtilities.sleep(1000);
	...
	public void checkTrade(List<String> skillList) throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By
				.xpath("html/body/div[2]/div/div[3]/form/div[4]/section/fieldset/ol/li[5]/div/ul/li[18]/label")));
