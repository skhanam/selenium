...
public class SignUpVariantE_ManualAddress {
	...
	public static Logger logger = Logger.getLogger(SignUpVariantE_ManualAddress.class.getName());

	public SignUpVariantE_ManualAddress(SeleniumTestContext context, TestScriptUtilities scriptUtilities) {
	...
	public void signUpVarEManualAddress(final String uniqueEmailAccountName, final String rollOnType, final String tariff, final String screeningType)
			throws Exception {
	...
	public void testDrivingLicenseScreeningDetailsPage(final String uniqueEmailAccountName, final String screeningType) throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(SignupVarEXpathlocators.xpathLookup.get("DL_ADDRESS_NOT_AVAILABLE"))));
		scriptUtilities.click(By.xpath(SignupVarEXpathlocators.xpathLookup.get("DL_ADDRESS_NOT_AVAILABLE")));

		scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("DL_ADDRESS_HOME_NUM"), SignupVarEXpathlocators.dataLookup.get("dl_property"));

		scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("DL_ADDRESS_STREET"), SignupVarEXpathlocators.dataLookup.get("dl_street"));
		scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("DL_ADDRESS_TOWN"), SignupVarEXpathlocators.dataLookup.get("dl_town"));
	...
	public void testPassportdetails(final String uniqueEmailAccountName, final String screeningType, final String dataset) {
...

		{
			...
			scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("PASSPORT_ADDRESS_HOME_NUM"),
					SignupVarEXpathlocators.dataLookup.get(dataset + "_passportGbr_property"));

			scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("PASSPORT_ADDRESS_STREET"),
					SignupVarEXpathlocators.dataLookup.get(dataset + "_passportGbr_street"));
			scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("PASSPORT_ADDRESS_TOWN"),
					SignupVarEXpathlocators.dataLookup.get(dataset + "_passportGbr_town"));
