...
public class PostJobViaPortableJobFormTestTwoSelectTwoPanels extends TestScript{
	...
	public void testWebdriverjunit() throws Exception {
		...
		driver.get(baseUrl + "/test-cases/test-case.php?jts=two-select-inputs&jdl=2&hwp=false&prese=false");
