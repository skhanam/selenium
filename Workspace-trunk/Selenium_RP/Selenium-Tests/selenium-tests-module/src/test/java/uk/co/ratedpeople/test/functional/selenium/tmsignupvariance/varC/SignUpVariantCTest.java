...
public class SignUpVariantCTest extends TestScript {

	private SignUpVariantC signupDrivingLicense;

	@BeforeClass
	public void beforeClass() throws Exception {

		signupDrivingLicense = new SignUpVariantC(this.context, scriptUtilities);
	}
	...
	public void signupVarCTest(final String rollOnType, final String tariff, final String screeningType) throws Exception {
		String uniqueEmailAccountName = new UniqueEmailAddressGenerator().generateUniqueEmailAddress();
		signupDrivingLicense.signUpVarC(uniqueEmailAccountName, rollOnType, tariff, screeningType);
	}
