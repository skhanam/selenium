...
public class SignUpVariant_A_AndLogin {
	...
	public static Logger logger = Logger.getLogger(SignUpVariant_A_AndLogin.class.getName());

	public SignUpVariant_A_AndLogin(SeleniumTestContext context, TestScriptUtilities scriptUtilities) {
