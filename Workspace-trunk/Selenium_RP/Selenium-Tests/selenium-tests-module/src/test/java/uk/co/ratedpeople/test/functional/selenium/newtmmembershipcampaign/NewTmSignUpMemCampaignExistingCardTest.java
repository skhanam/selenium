...
public class NewTmSignUpMemCampaignExistingCardTest extends TestScript{
...
@Test(enabled=false)
public void newTMSignUpGBRPassportTest() throws Exception {
	...
	underTest.getTMMembershipCampaignWithExistingCard();
