...
public class SignUpVariant_D_DynamicTextCheckTest extends TestScript {
	...
	private SignUpVariant_D_DynamicTextCheck signUpVariant_D_DynamicTextCheck;
	private UniqueEmailAddressGenerator uniqueEmailAddressGenerator;

	@BeforeClass
	public void beforeClass() throws Exception {
		signUpVariant_D_DynamicTextCheck = new SignUpVariant_D_DynamicTextCheck(this.context, scriptUtilities);
	...
	public static Object[][] data_15_30() {
		return new Object[][] { 
				...
				{ MONTHLY, _15_30_7F5940396C13, "PASSPORTOTHER", "15", "30", "15", "120" },
				{ ANNUAL, _15_30_7F5940396C13, "PASSPORTOTHER", "15", "30", "15", "120" },
	...
	public static Object[][] data_15_50() {
		return new Object[][] { 
				...
				{ MONTHLY, _15_50_0F05541D86B4, "PASSPORTOTHER", "15", "50", "15", "120" },
				{ ANNUAL, _15_50_0F05541D86B4, "PASSPORTOTHER", "15", "50", "15", "120" },
		};
	}
	...
	public void testSignUpVarD_15_30(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
		...
		signUpVariant_D_DynamicTextCheck.signUpVarD(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
	}

	@Test(dataProvider = "data_15_50", enabled = true)
	public void testSignUpVarD_15_50(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
			final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_D_DynamicTextCheck.signUpVarD(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
	...
	public void testSignUpVarD_0_50(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
			final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_D_DynamicTextCheck.signUpVarD(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
