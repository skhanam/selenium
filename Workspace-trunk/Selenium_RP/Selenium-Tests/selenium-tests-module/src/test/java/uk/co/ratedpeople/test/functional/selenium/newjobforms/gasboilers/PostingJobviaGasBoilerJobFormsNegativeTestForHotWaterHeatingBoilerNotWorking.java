...
public class PostingJobviaGasBoilerJobFormsNegativeTestForHotWaterHeatingBoilerNotWorking extends TestScript {

	private static final String RADIO_INSTALL = ".//*[@id='radioNotWorking']";
	private static final String CONTINUE_BUTTON = ".//*[@id='stage1SelectButton']";

	private static final String HOT_WATER = "tapYes";
	private static final String RADIATOR_HEAT = "heatYes";
	private static final String BOILER_MAKE = "89";
	...
	private static final String HOT_WATER_ERROR_XPATH = ".//*[@id='descNotWorking']/div[1]/div/div/label";
	private static final String RADIATOR_HEAT_ERROR_XPATH = ".//*[@id='descNotWorking']/div[2]/div/div/label";
	private static final String BOILER_MAKE_ERROR_XPATH = ".//*[@id='descNotWorking']/div[3]/div[2]/label";
	...
	private static final String SELECT_HOT_WATER = "Select whether your taps have hot water";
	private static final String SELECT_RADIATOR_HEAT = "Select whether your radiators heat up";
	private static final String SELECT_BOILER_MAKE = "Select a boiler from the list";
	...
	public void postingJobviaGasBoilersJobFormsNoFieldsSelectedTest() throws Exception {
		selectInstall();
		underTest.fillInBoilerNotWorkingStage2(null, null, null);

		assertEquals(context.driver.findElement(By.xpath(HOT_WATER_ERROR_XPATH)).getText(), SELECT_HOT_WATER);
		assertEquals(context.driver.findElement(By.xpath(RADIATOR_HEAT_ERROR_XPATH)).getText(), SELECT_RADIATOR_HEAT);
		assertEquals(context.driver.findElement(By.xpath(BOILER_MAKE_ERROR_XPATH)).getText(), SELECT_BOILER_MAKE);
	}

	@Test(enabled = true)
	public void postingJobviaGasBoilersJobForms_HotWaterNotSelected() throws Exception {

		selectInstall();
		underTest.fillInBoilerNotWorkingStage2(null, RADIATOR_HEAT, BOILER_MAKE);

		assertEquals(context.driver.findElement(By.xpath(HOT_WATER_ERROR_XPATH)).getText(), SELECT_HOT_WATER);
	}

	@Test(enabled = true)
	public void postingJobviaGasBoilersJobForms_RadiatorHeatNotSelected() throws Exception {

		selectInstall();
		underTest.fillInBoilerNotWorkingStage2(HOT_WATER, null, BOILER_MAKE);
	...
	public void postingJobviaGasBoilersJobForms_BoilerMakeNotSelected() throws Exception {
		...
		selectInstall();
		underTest.fillInBoilerNotWorkingStage2(HOT_WATER, RADIATOR_HEAT, null);
	...
	public void postingJobviaGasBoilersJobForms_Page4_InvalidPhoneNumberEntered() throws Exception {
		...
		JobFormSeleniumHelper
				.fillInContactPageDetailsAndPostJob(scriptUtilities, context, FIRSTNAME, LASTNAME, INVALID_PHONE_NUMBER, INVALID_PHONE_NUMBER, EMAIL, EMAIL);
	...
	public void postingJobviaGasBoilersJobForms_Page4_InvalidUKPhoneNumberEntered() throws Exception {
		...
		JobFormSeleniumHelper.fillInContactPageDetailsAndPostJob(scriptUtilities, context, FIRSTNAME, LASTNAME, INVALID_UK_PHONE_NUMBER, INVALID_UK_PHONE_NUMBER, EMAIL,
				EMAIL);
	...
	public void postingJobviaGasBoilersJobForms_Page4_InvalidEmailEntered() throws Exception {
		...
		JobFormSeleniumHelper
				.fillInContactPageDetailsAndPostJob(scriptUtilities, context, FIRSTNAME, LASTNAME, PHONE_NUMBER, PHONE_NUMBER, INVALID_EMAIL, INVALID_EMAIL);
	...
	public void selectJobDetailInfo() {
		underTest.fillInBoilerNotWorkingStage2(HOT_WATER, RADIATOR_HEAT, BOILER_MAKE);
	}
