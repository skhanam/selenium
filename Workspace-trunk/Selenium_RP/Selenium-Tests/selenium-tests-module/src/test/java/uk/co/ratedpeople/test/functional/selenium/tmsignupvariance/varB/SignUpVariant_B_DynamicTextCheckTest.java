...
public class SignUpVariant_B_DynamicTextCheckTest extends TestScript {
	...
	private SignUpVariant_B_DynamicTextCheck signUpVariant_B_DynamicTextCheck;
	private UniqueEmailAddressGenerator uniqueEmailAddressGenerator;

	@BeforeClass
	public void beforeClass() throws Exception {
		signUpVariant_B_DynamicTextCheck = new SignUpVariant_B_DynamicTextCheck(this.context, scriptUtilities);
	...
	public void testSignUpVarB_15_30(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
		...
		signUpVariant_B_DynamicTextCheck.signUpVarB(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
	}

	@Test(dataProvider = "data_15_50", enabled = true)
	public void testSignUpVarB_15_50(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
			final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_B_DynamicTextCheck.signUpVarB(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
	...
	public void testSignUpVarB_0_50(final String rollOnType, final String tariff, final String screeningType, final String upfrontAmount,
			final String freeLeadsAmount, final String monthlyRollOnAmount, final String annualRollOnAmount) throws Exception {
		String uniqueEmailAccountName = uniqueEmailAddressGenerator.generateUniqueEmailAddress();
		signUpVariant_B_DynamicTextCheck.signUpVarB(uniqueEmailAccountName, rollOnType, tariff, screeningType, upfrontAmount, freeLeadsAmount,
				monthlyRollOnAmount, annualRollOnAmount);
