...
public class SignUpVariantE_ManualAddressTest extends TestScript {

	private SignUpVariantE_ManualAddress signUpVariantE;

	@BeforeClass
	public void beforeClass() throws Exception {

		signUpVariantE = new SignUpVariantE_ManualAddress(this.context, scriptUtilities);
	}
	...
	public void signupVarETest(final String rollOnType, final String tariff, final String screeningType) throws Exception {
		...
		signUpVariantE.signUpVarEManualAddress(uniqueEmailAccountName, rollOnType, tariff, screeningType);
	}
