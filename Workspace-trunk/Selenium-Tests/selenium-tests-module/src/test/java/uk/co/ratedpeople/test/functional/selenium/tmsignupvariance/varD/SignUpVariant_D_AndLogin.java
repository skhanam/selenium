...
public class SignUpVariant_D_AndLogin {
	...
	public static Logger logger = Logger.getLogger(SignUpVariant_D_AndLogin.class.getName());

	public SignUpVariant_D_AndLogin(SeleniumTestContext context, TestScriptUtilities scriptUtilities) {
