...
public class PostJobViaPortableJobFormTestTwoPageOnePanel extends TestScript{
	...
	public void testWebdriverjunit() throws Exception {
		driver.get(baseUrl + "/test-cases/test-case.php?jts=two-page-block&jdl=1&hwp=false&prese=false");
		...
		assertEquals("Enter your postcode.", driver.findElement(By.cssSelector("div.relative > em" +
				".error")).getText());
