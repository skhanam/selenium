...
public class SignUpVariant_E_3DSecure_Negative {
	...
	public static Logger logger = Logger.getLogger(SignUpVariant_E_3DSecure_Negative.class.getName());
	private static final String THREE_DSECURE_NOT_REQUIRED = "3D Secure not required for this tariff";
	...
	public SignUpVariant_E_3DSecure_Negative(SeleniumTestContext context, TestScriptUtilities scriptUtilities) {
	...
	public String signupFailWhenPasswordIsBlank(final String uniqueEmailAccountName, final String rollOnType, final String tariff, final String screeningType,
			final String password) throws Exception {
		String result = THREE_DSECURE_NOT_REQUIRED;
		this.signUp(uniqueEmailAccountName, rollOnType, tariff, screeningType);
		if (!"418486a9e548".equals(tariff)) {
			testSagepayPage(password);
			// if the 3D-secure page timed out, return and show success as it is a false positive
			if (threeDSecurePageTimedOut) {
				return "password is required";
			}
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='billingForm']/em")));
			result = scriptUtilities.findElement(By.xpath(".//*[@id='billingForm']/em")).getText();
		}
		return result;
	}

	public String signUpFailWhenPasswordEmpty(final String uniqueEmailAccountName, final String rollOnType, final String tariff, final String screeningType,
			final String password) throws Exception {
		String result = THREE_DSECURE_NOT_REQUIRED;
		this.signUp(uniqueEmailAccountName, rollOnType, tariff, screeningType);
		if (!"418486a9e548".equals(tariff)) {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='AutoNumber1']/tbody/tr[2]/td/font[3]/li")));
			result = scriptUtilities.findElement(By.xpath(".//*[@id='AutoNumber1']/tbody/tr[2]/td/font[3]/li")).getText();
		}
		return result;
	}

	private void signUp(final String uniqueEmailAccountName, final String rollOnType, final String tariff, final String screeningType) throws Exception {
		...
		testSelectTradesPage(uniqueEmailAccountName);
		testSelectWorkareaPage(uniqueEmailAccountName);
	...
	public void testLandingPage(final String uniqueEmailAccountName, final String tariff) {
	...
	public void testSelectTradesPage(String uniqueEmailAccountName) {
	...
	public void testSelectWorkareaPage(String uniqueEmailAccountName) {
	...
	public void testBusinessDetailsPage(String uniqueEmailAccountName) throws InterruptedException {
		...
		String emailAccount = TestScriptUtilities.getRandomString(3) + uniqueEmailAccountName;
	...
	public void testPassportdetails(final String uniqueEmailAccountName, final String screeningType, final String dataset) {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(SignupVarEXpathlocators.xpathLookup.get("PASSPORT_ADDRESS_NOT_AVAILABLE"))));

		scriptUtilities.click(By.id(SignupVarEXpathlocators.xpathLookup.get("PASSPORT_ADDRESS_NOT_AVAILABLE")));

		scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("PASSPORT_ADDRESS_HOME_NUM"),
				SignupVarEXpathlocators.dataLookup.get(dataset + "_passport_property"));

		scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("PASSPORT_ADDRESS_STREET"),
				SignupVarEXpathlocators.dataLookup.get(dataset + "_passport_street"));
		scriptUtilities.fillInTextField(SignupVarEXpathlocators.xpathLookup.get("PASSPORT_ADDRESS_TOWN"),
				SignupVarEXpathlocators.dataLookup.get(dataset + "_passport_town"));
	...
	public void testCreateTMbillingDetailsPPage() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(SignupVarEXpathlocators.xpathLookup.get("CREDITCARD_NAME"))));
		scriptUtilities.clear(By.id(SignupVarEXpathlocators.xpathLookup.get("CREDITCARD_NAME")));
		...
		scriptUtilities.clear(By.id(SignupVarEXpathlocators.xpathLookup.get("CREDITCARD_NUM")));
		...
		scriptUtilities.clear(By.id(SignupVarEXpathlocators.xpathLookup.get("CREDITCARD_SECURITY_CODE")));
	...
	public void testSagepayPage(final String password) throws InterruptedException {
		...
		try {
			...
			scriptUtilities.fillInXpathField(SignupVarEXpathlocators.xpathLookup.get("CREDITCARD_3D_PASSWORD"), password);
