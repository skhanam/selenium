...
public class PostingJobviaGasBoilerJobFormsNegativeTestForSomethingElse extends TestScript {

	private static final String RADIO_INSTALL = ".//*[@id='radioElse']";
	...
	private static final String BUDGET_ERROR_XPATH = ".//*[@id='stage3']/div[1]/div[2]/label";
