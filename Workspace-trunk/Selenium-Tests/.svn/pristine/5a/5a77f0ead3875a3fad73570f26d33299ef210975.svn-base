...
public class PostJobViaPortableJobFormTestTwoPageTwoPanelsShowPanel extends TestScript{
	...
	public void testWebdriverjunit() throws Exception {
		driver.get(baseUrl + "/test-cases/test-case.php?jts=two-page-block&jdl=2&hwp=true&prese=false");
		...
		Thread.sleep(2000);
		//checkpanel exists
		assertEquals("Find quality, local tradesmen quickly and easily.", driver.findElement(By.xpath("//html/body/div/div/div/div[3]/aside/h3")).getText());	
