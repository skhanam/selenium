...
public class SignUpVariant_B_AndLogin {
	...
	public static Logger logger = Logger.getLogger(SignUpVariant_B_AndLogin.class.getName());

	public SignUpVariant_B_AndLogin(SeleniumTestContext context, TestScriptUtilities scriptUtilities) {
