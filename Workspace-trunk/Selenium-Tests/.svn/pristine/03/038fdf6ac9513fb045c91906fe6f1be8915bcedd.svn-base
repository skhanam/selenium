...
public class PostingJobviaGasBoilerJobFormsNegativeTestForServiceGasApplicance extends TestScript {

	private static final String RADIO_INSTALL = ".//*[@id='radioService']";
	private static final String CONTINUE_BUTTON = ".//*[@id='stage1SelectButton']";

	private static final String BOILER_OPTION = ".//*[@id='descService']/div[1]/div[1]/ul/li[1]/a[2]";
	private static final String OTHER_OPTION = ".//*[@id='descService']/div[1]/div[2]/ul/li[2]/a[2]";
	private static final String BOILER_MAKE_ID = "142";
	private static final String GAS_CERTIFICATE_RADIO_ID = "certificateNo";
	...
	private static final String STAGE2_OPTION_ERROR_XPATH = ".//*[@id='descService']/div[1]/div[3]/div/label";
	private static final String BOILER_REQUIRED_ERROR_XPATH = ".//*[@id='descService']/div[2]/div[2]/label";
	private static final String OTHER_FIELD_ADDITIONAL_INFO_ERROR_XPATH = ".//*[@id='descService']/div[1]/div[2]/ul/li[2]/div/div";
	private static final String GAS_CERTIFICATE_ERROR_XPATH = ".//*[@id='descService']/div[3]/div/div/label";
	...
	private static final String SELECT_GAS_CERTIFICATE = "Select whether you require gas certificates";
	private static final String OTHER_FIELD = "This field is required";
	...
	public void postingJobviaGasBoilersJobFormsNoFieldsSelectedTest() throws Exception {
		selectInstall();
		underTest.fillInServiceGasApplianceStage2(null, null, null, null, null);

		assertEquals(context.driver.findElement(By.xpath(STAGE2_OPTION_ERROR_XPATH)).getText(), SELECT_AN_OPTION);
		assertEquals(context.driver.findElement(By.xpath(GAS_CERTIFICATE_ERROR_XPATH)).getText(), SELECT_GAS_CERTIFICATE);
	}
	...
	public void postingJobviaGasBoilersJobForms_CurrentBoilerMakeNotSelected() throws Exception {
		...
		selectInstall();
		underTest.fillInServiceGasApplianceStage2(BOILER_OPTION, null, null, null, GAS_CERTIFICATE_RADIO_ID);
	...
	public void postingJobviaGasBoilersJobForms_AdditionalOtherInfoNotSpecified() throws Exception {
		...
		selectInstall();
		underTest.fillInServiceGasApplianceStage2(null, null, OTHER_OPTION, null, GAS_CERTIFICATE_RADIO_ID);

		assertEquals(context.driver.findElement(By.xpath(OTHER_FIELD_ADDITIONAL_INFO_ERROR_XPATH)).getText(), OTHER_FIELD);
	}

	@Test(groups = { "sanity" }, enabled = true)
	public void postingJobviaGasBoilersJobForms_GasCertificateRequiredNotSelected() throws Exception {

		selectInstall();
		underTest.fillInServiceGasApplianceStage2(BOILER_OPTION, BOILER_MAKE_ID, null, null, null);
	...
	public void selectJobDetailInfo() throws InterruptedException {
		underTest.fillInServiceGasApplianceStage2(BOILER_OPTION, BOILER_MAKE_ID, OTHER_OPTION, TestScriptUtilities.getRandomString(30),
				GAS_CERTIFICATE_RADIO_ID);
	}
